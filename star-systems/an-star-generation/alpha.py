...
def new_system(p):
    ...
    print "radius_r: " + str(radius_ratio)

    
    surface_temp = star_surface_temperature(lum, radius)
    return {"star": {"solar_masses": mass_ratio,
                     "spectral_type": stype,
                     "lum_ratio": lum_ratio,
...
# PLANETS
#
# per individual star or P-type orbit, see:
# https://worldbuilding.stackexchange.com/questions/63133/how-can-a-planet-orbit-two-or-more-stars-simultaneously
MAX_PLANETS = 12
